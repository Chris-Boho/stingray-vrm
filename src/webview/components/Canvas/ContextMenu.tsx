...
import { useClipboardStore, useClipboardOperations } from '../../stores/clipboardStore';
...
export const ContextMenu: React.FC<ContextMenuProps> = ({
  ...
  const handleClipboardAction = useCallback((action: string) => {
    switch (action) {
      case 'copy':
  ...
  const buildMenuSections = useCallback((): MenuSection[] => {
    ...
    mainMenuItems.push({
      ...
      submenu: [
        ...
        {
          id: 'edit-paste',
          label: hasData ? `Paste (${clipboardInfo})` : 'Paste',
                  ...
                  <>
                    <button
                      className={`
                        ...
                        ${item.id === 'edit-paste' && hasData ? 'bg-blue-500/10 border-l-2 border-blue-500' : ''}
                      `}
